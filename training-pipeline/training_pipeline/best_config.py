...
def upload(sweep_id: Optional[str] = None):
    ...
    Args:
        sweep_id (Optional[str], optional): sweep_id (Optional[str], optional): Sweep ID to look for the best config. If None, it will look for the last sweep in the cached last_sweep_metadata.json file. Defaults to None.
    """
