...
# Create dropdown for are selection.
area_response = requests.get(API_URL/"area_values")

area = st.selectbox(
    label="Denmark is divded in two price areas, or bidding zones, \
        divided by the Great Belt, DK(shown as 1) is west of the Great Belt \
...
# Check if both area and customer type have values listed.
