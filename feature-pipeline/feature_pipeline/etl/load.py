...
def to_feature_store(
    ...
    energy_feature_group = feature_store.get_or_create_feature_group(
        ...
        description= "Denmark hourly consumption data. Data is uploaded with an 15 days delay.",
    ...
    feature_descriptions = [
        {
            "name": "datetime_utc",
            "description": """
                            Datetime interval inn UTC when the data was observed.
                            """,
        ...
        },
        {
            ...
            "description": """
                            ...
                            """,
            "validation_rules": "0 (DK), 1 (DK1) or (DK2) int",
        },
        {
